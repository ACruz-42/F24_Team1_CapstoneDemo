...
\logotitletwo{\includegraphics[height=5.0cm]{QR_Code.jpg}}
...
\begin{figure}
      ...
      \caption{Game Field to compete on. There are white lines to help navigate. The two containers and materials are shown. The starting zone is the large white square. The posts on the left half are covered with a tarp to provide a dark enclosed area.}
    \end{figure}
